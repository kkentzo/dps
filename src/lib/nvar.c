...
// calculate the variance of the specified variable
// if NORM, the standard deviation is returned
// internally, it calls nvar_calc_covariance(..., idx, idx, norm)
double nvar_calc_variance(nvar_t *nvar, int idx, int norm) {

    return nvar_calc_covariance(nvar, idx, idx, norm);
